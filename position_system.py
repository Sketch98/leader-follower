...
class PositionSystem:
    ...
    def __init__(self, pi, servo_pin, frame_rate):
        self.pi = pi
        self.servo_controller = ServoController(pi, servo_pin)
    ...
    def find_ball_pos(self, x, diameter, screenwidth):
        if x < 0:
            # TODO: the servo should look for the ball in the case nothing is
            #  found
        ...
        (x_pos, y_pos, ball_angle) = ball_estimator.calc_ball_coordinates(
            servo_angle, x, diameter, screenwidth)
